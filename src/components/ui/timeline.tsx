...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  function calculateDevExperience() {
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-xl">
          I&apos;ve been working as a developer for the past {calculateDevExperience()}.<br /> Here&apos;s
          a timeline of my journey including school.
        </p>
      </div>
